...
# Create canvas
sns.set(style='ticks')
fig, ax = plt.subplots(3, 2, sharex=True, sharey=True, figsize=(6, 6), dpi = 100)
# Grid spec
ctrl_len = len(control_list)
gs = gridspec.GridSpec(3, 2, width_ratios=[ctrl_len+10, end_aa]) 
...
sns.distplot(mergedDataSingleCon, kde=False, color="k", ax=ax[0,1], bins=end_aa)
ax[0,1].set_xlabel('')
